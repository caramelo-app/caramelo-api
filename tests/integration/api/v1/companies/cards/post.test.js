...
describe("POST /api/v1/companies/cards", () => {
      ...
      test("Should return 200 status after create a company card", async () => {
        ...
        const response = await fetch(endpoint, {
          ...
          body: JSON.stringify({
            ...
            credit_expires_at: {
              ref_number: 10,
              ref_type: datesConstants.TYPES.DAY,
            },
          }),
        });
        ...
        expect(body.credits_needed).toBe(10);
        expect(body.credit_expires_at.ref_number).toBe(10);
        expect(body.credit_expires_at.ref_type).toBe(datesConstants.TYPES.DAY);
