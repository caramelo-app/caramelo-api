...
describe("POST /api/v1/companies/users", () => {
  ...
  describe("Authenticated user", () => {
    ...
    describe("User has a client role", () => {
      test("Should return 200 status after create user", async () => {
        ...
        expect(body.message).toBe(localize("companies.users.create.success"));
      });
