...
const endpoint = `${process.env.SERVER_HOST}:${process.env.SERVER_PORT}/api/v1/companies/profile`;
...
describe("PATCH /api/v1/companies/profile", () => {
  ...
  describe("Authenticated user", () => {
    ...
    describe("User has a client role", () => {
      test("Should return 200 status after update the company profile", async () => {
        ...
        expect(body.message).toBe(localize("companies.profile.update.success"));
      });
