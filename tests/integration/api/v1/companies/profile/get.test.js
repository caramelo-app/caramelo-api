...
describe("GET /api/v1/companies/profile", () => {
  ...
  describe("Authenticated user", () => {
    ...
    describe("User has a client role", () => {
      test("Should return 200 status after get the company profile", async () => {
        ...
        expect(body.name).toBe(company.documentsCreatedOnMongo[0].name);
        expect(body.logo).toBe(company.documentsCreatedOnMongo[0].logo);
        expect(body.address).toEqual(company.documentsCreatedOnMongo[0].address);
        expect(body.segment).toEqual({
          _id: company.documentsCreatedOnMongo[0].segment._id.toString(),
          name: company.documentsCreatedOnMongo[0].segment.name,
          description: company.documentsCreatedOnMongo[0].segment.description,
          icon: company.documentsCreatedOnMongo[0].segment.icon,
        });
        expect(body.document).toBe(company.documentsCreatedOnMongo[0].document);
      });
